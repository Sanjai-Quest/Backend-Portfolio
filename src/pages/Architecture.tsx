...
export const Architecture: React.FC = () => {
  ...
  const topologyData = useMemo(() => {
    return {
      ...
      TRINETRA: {
        nodes: [
          { id: "ui", type: "blueprint", data: { label: "Retail Analytics UI", subtitle: "Supervisors Console" }, position: { x: 280, y: 10 } },
          { id: "backend", type: "blueprint", data: { label: "Ingestion API", subtitle: "trinetra-core", status: "Healthy" }, position: { x: 280, y: 110 } },
          { id: "model", type: "blueprint", data: { label: "Decision Model", subtitle: "Fraud AI Ingestion" }, position: { x: 140, y: 215 } },
