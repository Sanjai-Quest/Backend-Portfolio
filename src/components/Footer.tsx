...
export const Footer: React.FC = () => {
  return (
    <footer className="h-8 shrink-0 border-t border-border-primary bg-card-bg px-4 flex items-center justify-between text-[11px] font-mono text-text-muted select-none">
